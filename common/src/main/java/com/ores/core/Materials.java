...
public enum Materials {
    ...
    COAL("coal", "minecraft:coal",
            new ItemProps(64, Rarity.COMMON, false, 3355443, 1600),
            ...
            new Tags(false, false, false, false),
    ...
    IRON("iron", "minecraft:iron_ingot",
            ...
            new Tags(true, false, false, false),
    ...
    public record Tags(
            Boolean beacon, Boolean piglinRepellents, Boolean piglinLoved, Boolean piglinFood
    ) {}
