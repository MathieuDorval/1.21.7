/**
 * ORES MOD | __mathieu
 * Defines all material variants, their properties, and associated data.
 */
...
public enum Variants {
    ...
    // === COMPRESSED ===
    COMPRESSED_BLOCK("compressed_%s_block", Category.BLOCK, new String[]{"compressed_x9", "compressed_x6", "compressed_x3"}, new BlockProps(5.0f, 6.0f, true, 0, null, null, null, null, null, null, 64, 0, Materials.Tools.PICKAXE, 8100, true, ColorType.BASE)),
    DOUBLE_COMPRESSED_BLOCK("double_compressed_%s_block", Category.BLOCK, new String[]{"compressed_x9", "compressed_x6", "compressed_x3"}, new BlockProps(10.0f, 12.0f, true, 0, null, null, null, null, null, null, 64, 0, Materials.Tools.PICKAXE, 72900, true, ColorType.BASE)),
    TRIPLE_COMPRESSED_BLOCK("triple_compressed_%s_block", Category.BLOCK, new String[]{"compressed_x9", "compressed_x6", "compressed_x3"}, new BlockProps(20.0f, 24.0f, true, 0, null, null, null, null, null, null, 64, 0, Materials.Tools.PICKAXE, 656100, true, ColorType.BASE)),
    QUADRUPLE_COMPRESSED_BLOCK("quadruple_compressed_%s_block", Category.BLOCK, new String[]{"compressed_x9", "compressed_x6"}, new BlockProps(40.0f, 48.0f, true, 0, null, null, null, null, null, null, 64, 0, Materials.Tools.PICKAXE, 5904900, true, ColorType.BASE)),
    QUINTUPLE_COMPRESSED_BLOCK("quintuple_compressed_%s_block", Category.BLOCK, new String[]{"compressed_x9", "compressed_x6"}, new BlockProps(80.0f, 96.0f, true, 0, null, null, null, null, null, null, 64, 0, Materials.Tools.PICKAXE, 53144100, true, ColorType.BASE)),
    SEXTUPLE_COMPRESSED_BLOCK("sextuple_compressed_%s_block", Category.BLOCK, new String[]{"compressed_x9", "compressed_x6"}, new BlockProps(160.0f, 192.0f, true, 0, null, null, null, null, null, null, 64, 0, Materials.Tools.PICKAXE, 478296900, true, ColorType.BASE)),
    SEPTUPLE_COMPRESSED_BLOCK("septuple_compressed_%s_block", Category.BLOCK, new String[]{"compressed_x9"}, new BlockProps(320.0f, 384.0f, true, 0, null, null, null, null, null, null, 64, 0, Materials.Tools.PICKAXE, 478296900, true, ColorType.BASE)),
    OCTUPLE_COMPRESSED_BLOCK("octuple_compressed_%s_block", Category.BLOCK, new String[]{"compressed_x9"}, new BlockProps(640.0f, 768.0f, true, 0, null, null, null, null, null, null, 64, 0, Materials.Tools.PICKAXE, 478296900, true, ColorType.BASE)),
    NONUPLE_COMPRESSED_BLOCK("nonuple_compressed_%s_block", Category.BLOCK, new String[]{"compressed_x9"}, new BlockProps(1280.0f, 1536.0f, true, 0, null, null, null, null, null, null, 64, 0, Materials.Tools.PICKAXE, 478296900, true, ColorType.BASE)),
